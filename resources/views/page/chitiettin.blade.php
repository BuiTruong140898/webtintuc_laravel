            ...
            <div class="col-md-3">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-5">
                                <a href="chitiettin/{{$tlq->id}}/{{$tlq->TenKhongDau}}.html">
                            ...
                            <p style="margin: 10px">{!!$tlq->TomTat!!}</p>
                            <div class="break"></div>
                        </div>
                        <!-- end item -->
                        @endforeach
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-5">
                                <a href="chitiettin/{{$tnb->id}}/{{$tnb->TenKhongDau}}.html">
                            ...
                            <p style="padding: 5px">{!!$tnb->TomTat!!}</p>
                            <div class="break"></div>
                        </div>
                        <!-- end item -->
